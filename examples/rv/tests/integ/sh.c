...
int main(int argc, char** argv){
  ...
  char data[] = {
    0x37, 0x21, 0x00, 0x00, // lui sp, 0x2
    0x17, 0x05, 0x00, 0x00, // auipc a0, 0x0
    0x13, 0x05, 0x05, 0x04, // add a0, a0, 64 # <hello_string>
    0xef, 0x00, 0x00, 0x01, // jal 1c <putchars>
    0xb7, 0x15, 0x00, 0x40, // lui 0x40001
    0x23, 0xa0, 0x05, 0x00, // sw zero, 0(a1) @ 40001000 <EXIT_ADDR>
    // <loop>:
    0x6f, 0x00, 0x00, 0x00, // j loop
    // <putchars>:
    0x93, 0x82, 0x00, 0x00, // mv t0, ra
    0x13, 0x06, 0x05, 0x00, // mv a2, a0
    0xb7, 0x05, 0x00, 0x40, // lui a1, 0x40000
    // <.start_loop>:
    0x03, 0x05, 0x06, 0x00, // lb a0, 0(a2)
    0x63, 0x08, 0x05, 0x00, // beqz a0, 3c <.end_putchars>
    0x23, 0xa0, 0xa5, 0x00, // sw a0, 0(a1) # 40000000 <UART_ADDR>
    0x13, 0x06, 0x16, 0x00, // add a2, a2, 1
    0x6f, 0xf0, 0x1f, 0xff, // j <.start_loop>
    // <.end_putchars>
    0x93, 0x80, 0x02, 0x00, // mv ra, t0
    0x67, 0x80, 0x00, 0x00, // ret
    // <hello_string>: "Bonjour\r\n\0\0\0"
    0x42, 0x6f, 0x6e, 0x6a, 0x6f, 0x75, 0x72, 0x0d, 0x0a, 0x00, 0x00, 0x00
  };
