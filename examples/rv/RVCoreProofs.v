...
(* (1*         ssearch_in_var (@SBinop RV32I.reg_t RV32I.ext_fn_t (UEq false) *1) *)
(* (1*                           (SConst (Bits [x0])) *1) *)
(* (1*                           (SConst (Bits [x0])) *1) *)
(* (1*                        ) (vars sf0) 1810%positive *1) *)
(* (1*           (@SConst RV32I.reg_t RV32I.ext_fn_t (Bits [true])) (bits_t 1). *1) *)
(* (1*         intro A. trim A. vm_compute. reflexivity. *1) *)
(* (1*         trim A. repeat econstructor. *1) *)
(* (1*         trim A. repeat econstructor. *1) *)
(* (1*         trim A. *1) *)
(* (1*         eapply ReplaceSubact.interp_sact_iff_from_implies; eauto. *1) *)
(* (1*         apply wfsf. apply wfsf. *1) *)
(* (1*         repeat econstructor. *1) *)
(* (1*         intros. inv H. inv H9. inv H11. simpl in H12. inv H12. *1) *)
(* (1*         rewrite andb_true_r. rewrite eqb_reflx. constructor. *1) *)
(* (1*         trim A. inversion 1. *1) *)
(* (1*         exploit_subact. clear A. isolate_sf. *1) *)
(* (1*         get_subact_ok ((@SBinop RV32I.reg_t RV32I.ext_fn_t (UBits2 UOr) *1) *)
(* (1*                    (SBinop (UEq false) (SConst (Bits [true; false; x13; false; false])) *1) *)
(* (1*                       (SConst (Bits [true; false; false; false; false]))) *1) *)
(* (1*                    (SBinop (UEq false) (SConst (Bits [true; false; x13; false; false])) *1) *)
(* (1*                       (SConst (Bits [true; false; true; false; false]))))) *1) *)
(* (1*           (vars sf0) *1) *)
(* (1*           (@SConst RV32I.reg_t RV32I.ext_fn_t (Bits [true])) (bits_t 1) *1) *)
(* (1*         . *1) *)
(* (1*         intro A. *1) *)
...
(* (1*         apply wfsf. apply wfsf. *1) *)
(* (1*         repeat econstructor. *1) *)
(* (1*         intros. inv H. inv H9. inv H11. inv H5. inv H13. inv H9. inv H15. *1) *)
(* (1*         simpl in H14, H16. inv H14; inv H16. *1) *)
(* (1*         simpl in H12. inv H12. *1) *)
(* (1*         clear. destruct x13; cbn [Bool.eqb andb]; constructor. *1) *)
(* (1*         trim A. inversion 1. *1) *)
(* (1*         exploit_subact. clear A. isolate_sf. *1) *)
(* (1*         full_pass_c. *1) *)
(* (1*         full_pass_c. *1) *)
...
(* (1* Lemma step_preserves_non_sstack_vars_eq_when_no_sstack_violation: *1) *)
(* (1*   forall *1) *)
(* (1*     (ctx': env_t REnv (fun _ => val)) (WTRENV': Wt.wt_renv RV32I.R REnv ctx'), *1) *)
(* (1*   getenv REnv ctx RV32I.sstack_activated = Bits [true] *1) *)
(* (1*   -> getenv REnv ctx' RV32I.sstack_activated = Bits [false] *1) *)
(* (1*   -> non_sstack_vars_eq ctx ctx' *1) *)
(* (1*   -> non_sstack_vars_eq *1) *)
(* (1*        (interp_cycle ctx ext_sigma sf) (interp_cycle ctx' ext_sigma sf). *1) *)
(* (1* Proof. *1) *)
...
(* (1* Lemma step_preserves_non_sstack_vars_eq_when_no_sstack_violation: *1) *)
(* (1*   forall (ctx': env_t REnv (fun _ => val)) b, *1) *)
(* (1*   (getenv REnv ctx RV32I.sstack_activated = Bits [b]) *1) *)
(* (1*   -> (getenv REnv ctx' RV32I.sstack_activated = Bits [negb b]) *1) *)
(* (1*   -> non_sstack_vars_eq ctx ctx' *1) *)
(* (1*   -> non_sstack_vars_eq *1) *)
(* (1*        (interp_cycle ctx ext_sigma sf) (interp_cycle ctx' ext_sigma sf). *1) *)
(* (1* Proof. *1) *)
