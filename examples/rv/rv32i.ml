...
let index_of_nat_lt sz0 n =
  let o = index_of_nat sz0 n in
  (match o with
   | Some idx -> idx
...
module Bits =
 struct
        ...
        vect_split
          (let rec rmul0 n1 m =
             (fun fO fS n -> if n=0 then fO () else fS (n-1))
               ...
               n1
           in rmul0 n0 sz0) sz0 bs
      in
      Obj.magic vect_cons n0 hd (splitn n0 sz0 rest))
      n

  (** val appn : int -> int -> bool vect vect -> bool vect **)

  let rec appn n sz0 bss =
    (fun fO fS n -> if n=0 then fO () else fS (n-1))
      (fun _ -> Obj.magic __ bss)
      (fun n0 ->
      let x = vect_hd n0 (Obj.magic bss) in
      let y = appn n0 sz0 (vect_tl n0 (Obj.magic bss)) in
      vect_app (rmul n0 sz0) sz0 y x)
      n
  ...
  let of_index sz0 n idx =
    of_nat sz0 (index_to_nat n idx)
...
let show_index n =
  { show0 = (fun x -> show_nat.show0 (index_to_nat n x)) }
...
let opt_constprop cR cSigma sz0 c =
  (fun fO fS n -> if n=0 then fO () else fS (n-1))
    ...
    (fun n ->
    opt_mux_bit1 cR cSigma (Pervasives.succ n)
      (opt_constprop' cR cSigma (Pervasives.succ n) c))
    sz0
...
let signExtend n m =
  { int_name =
    ...
    ((prod_of_argsig { arg_name = ('a'::('r'::('g'::[]))); arg_type = (Bits_t
       n) }) :: []); int_retSig = (Bits_t (add m n)); int_body = (UUnop
    ((PrimUntyped.UBits1 (PrimUntyped.USExt (add m n))), (UVar
    ('a'::('r'::('g'::[])))))) }
...
module Scoreboard =
 ...
 struct
  ...
  let name_reg = function
  | Scores n -> append ('r'::('f'::[])) (Rf.name_reg n)
...
module RV32I =
 struct
  ...
  (** val reg_t_rect :
      ...
      (Coq_fromExecute.reg_t -> 'a1) -> (Rf.reg_t -> 'a1) -> (Stack.reg_t ->
  ...
  let host_id =
    { enum_name = ('h'::('o'::('s'::('t'::('I'::('D'::[])))))); enum_size =
      (Pervasives.succ (Pervasives.succ (Pervasives.succ 0))); enum_bitsize =
      (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
      (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
      0)))))))); enum_members =
      (Obj.magic vect_cons (Pervasives.succ (Pervasives.succ 0))
        ('F'::('P'::('G'::('A'::[]))))
        (vect_cons (Pervasives.succ 0)
          ('V'::('e'::('r'::('i'::('l'::('a'::('t'::('o'::('r'::[])))))))))
          (Obj.magic vect_cons 0
            ('C'::('u'::('t'::('t'::('l'::('e'::('s'::('i'::('m'::[])))))))))
            __))); enum_bitpatterns =
      (vect_map (Pervasives.succ (Pervasives.succ (Pervasives.succ 0)))
        (Bits.of_nat (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ 0)))))))))
        (Obj.magic vect_cons (Pervasives.succ (Pervasives.succ 0))
          ...
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
          0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
          (vect_cons (Pervasives.succ 0) (Pervasives.succ 0)
            (Obj.magic vect_cons 0 0 __)))) }
  ...
  (** val decode :
      reg_t finiteType -> Stack.reg_t finiteType -> (pos_t, var_t, fn_name_t,
      reg_t, ext_fn_t) uaction **)
  ...
  let execute_1 finite_reg0 finite_reg_stack =
    UBind (('f'::('I'::('n'::('s'::('t'::[]))))), (UUnop
      ...
      (Bits.of_N (Pervasives.succ (Pervasives.succ (Pervasives.succ
        ...
        (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
        (Pervasives.succ 0)))))))))))))))))))))))))))))))) ((fun p->2*p)
        ((fun p->2*p) 1)))))))))), (UBind (('r'::('e'::('s'::[]))), (USugar
      (UConstBits ((Pervasives.succ 0), (Obj.magic vect_cons 0 false __)))),
      ...
      (Bits.of_N (Pervasives.succ (Pervasives.succ (Pervasives.succ
        (Pervasives.succ (Pervasives.succ 0))))) ((fun p->1+2*p)
        ((fun p->1+2*p) ((fun p->1+2*p) 1))))))))), (USeq ((UIf ((UBinop
          ...
          (Obj.magic vect_cons (Pervasives.succ (Pervasives.succ
            ...
            (vect_cons (Pervasives.succ (Pervasives.succ (Pervasives.succ
              ...
              (Obj.magic vect_cons (Pervasives.succ (Pervasives.succ 0))
                ...
                (vect_cons (Pervasives.succ 0) true
                  (Obj.magic vect_cons 0 true __)))))))))))), (UBinop
      ((PrimUntyped.UBits2 PrimUntyped.UOr), (UBinop ((PrimUntyped.UEq
      false), (UVar ('r'::('d'::('_'::('v'::('a'::('l'::[]))))))), (USugar
      (UConstBits ((Pervasives.succ (Pervasives.succ (Pervasives.succ
      (Pervasives.succ (Pervasives.succ 0))))),
      (Bits.of_N (Pervasives.succ (Pervasives.succ (Pervasives.succ
          ...
          (Obj.magic vect_cons (Pervasives.succ (Pervasives.succ
            ...
            (vect_cons (Pervasives.succ (Pervasives.succ (Pervasives.succ
              ...
              (Obj.magic vect_cons (Pervasives.succ (Pervasives.succ 0))
                false
                (vect_cons (Pervasives.succ 0) true
                  (Obj.magic vect_cons 0 true __)))))))))))), (UIf ((UBinop
      ((PrimUntyped.UBits2 PrimUntyped.UAnd), (UBinop ((PrimUntyped.UEq
      false), (UVar ('r'::('d'::('_'::('v'::('a'::('l'::[]))))))), (USugar
      (UConstBits ((Pervasives.succ (Pervasives.succ (Pervasives.succ
      (Pervasives.succ (Pervasives.succ 0))))),
      ...
      (Bits.of_N (Pervasives.succ (Pervasives.succ (Pervasives.succ
        (Pervasives.succ (Pervasives.succ 0))))) 1)))))), (UBinop
      ((PrimUntyped.UEq true), (UVar ('r'::('s'::('1'::[])))), (USugar
      (UConstBits ((Pervasives.succ (Pervasives.succ (Pervasives.succ
      (Pervasives.succ (Pervasives.succ 0))))),
      (Bits.of_N (Pervasives.succ (Pervasives.succ (Pervasives.succ
        (Pervasives.succ (Pervasives.succ 0))))) ((fun p->1+2*p)
      ...
      ((Obj.magic finite_reg_stack), (Obj.magic (fun x -> Coq_stack x)),
      (Obj.magic lift_empty), (Obj.magic Stack.pop), ((UVar
      ('a'::('d'::('d'::('r'::[]))))) :: [])))))), (UAssign
      (('r'::('e'::('s'::[]))), (UBinop ((PrimUntyped.UBits2
      PrimUntyped.UOr), (UVar ('r'::('e'::('s'::[])))), (USugar (UCallModule
      ((Obj.magic finite_reg_stack), (Obj.magic (fun x -> Coq_stack x)),
      (Obj.magic lift_empty), (Obj.magic Stack.push), ((UVar
      ('d'::('a'::('t'::('a'::[]))))) :: [])))))))))))), (UIf ((UBinop
      ((PrimUntyped.UBits2 PrimUntyped.UOr), (UBinop ((PrimUntyped.UEq
      false), (UVar ('r'::('s'::('1'::[])))), (USugar (UConstBits
      ((Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
      (Pervasives.succ 0))))),
      (Bits.of_N (Pervasives.succ (Pervasives.succ (Pervasives.succ
        (Pervasives.succ (Pervasives.succ 0))))) 1)))))), (UBinop
      ((PrimUntyped.UEq false), (UVar ('r'::('s'::('1'::[])))), (USugar
      (UConstBits ((Pervasives.succ (Pervasives.succ (Pervasives.succ
      (Pervasives.succ (Pervasives.succ 0))))),
      (Bits.of_N (Pervasives.succ (Pervasives.succ (Pervasives.succ
        (Pervasives.succ (Pervasives.succ 0))))) ((fun p->1+2*p)
        ((fun p->2*p) 1)))))))))), (UAssign (('r'::('e'::('s'::[]))), (USugar
      (UCallModule ((Obj.magic finite_reg_stack),
      (Obj.magic (fun x -> Coq_stack x)), (Obj.magic lift_empty),
      (Obj.magic Stack.pop), ((UVar
      ('a'::('d'::('d'::('r'::[]))))) :: [])))))), (USugar (UConstBits (0,
      (Obj.magic __)))))))), (USugar (UConstBits (0, (Obj.magic __)))))))),
      (UWrite (P0, Coq_halt, (UVar ('r'::('e'::('s'::[])))))))))))))),
      (USugar (UConstBits (0, (Obj.magic __)))))))), (UBind
  ...
  (** val mem :
      memory -> reg_t finiteType -> Stack.reg_t finiteType -> (pos_t, var_t,
  ...
  (** val rv_register_name : int -> index -> char list **)

  let rv_register_name n v =
    (fun fO fS n -> if n=0 then fO () else fS (n-1))
      (fun _ ->
      'x'::('0'::('0'::('_'::('z'::('e'::('r'::('o'::[]))))))))
      (fun n0 ->
  ...
  (** val coq_FiniteType_toIMem : MemReq.reg_t finiteType **)

  let coq_FiniteType_toIMem =
    MemReq.coq_FiniteType_reg_t

  (** val coq_FiniteType_fromIMem : MemResp.reg_t finiteType **)

  let coq_FiniteType_fromIMem =
    MemResp.coq_FiniteType_reg_t

  (** val coq_FiniteType_toDMem : MemReq.reg_t finiteType **)

  let coq_FiniteType_toDMem =
    coq_FiniteType_toIMem

  (** val coq_FiniteType_fromDMem : MemResp.reg_t finiteType **)

  let coq_FiniteType_fromDMem =
    coq_FiniteType_fromIMem

  (** val coq_FiniteType_f2d : Coq_fromFetch.reg_t finiteType **)

  let coq_FiniteType_f2d =
    Coq_fromFetch.coq_FiniteType_reg_t

  (** val coq_FiniteType_d2e : Coq_fromDecode.reg_t finiteType **)

  let coq_FiniteType_d2e =
    Coq_fromDecode.coq_FiniteType_reg_t

  (** val coq_FiniteType_e2w : Coq_fromExecute.reg_t finiteType **)

  let coq_FiniteType_e2w =
    Coq_fromExecute.coq_FiniteType_reg_t

  (** val coq_Show_rf : Rf.reg_t show **)

  let coq_Show_rf =
    { show0 = (fun pat ->
      let Rf.Coq_rData v = pat in rv_register_name Rf.sz v) }

  (** val coq_Show_scoreboard : Scoreboard.reg_t show **)

  let coq_Show_scoreboard =
    { show0 = (fun pat ->
      let Scoreboard.Scores state = pat in
      let Scoreboard.Rf.Coq_rData v = state in
      rv_register_name Scoreboard.Rf.sz v) }
      ...
      | Coq_e2w state ->
        'e'::('2'::('w'::('_'::(match state with
                                ...
                                | Coq_fromExecute.Coq_valid0 ->
                                  'v'::('a'::('l'::('i'::('d'::('0'::[])))))))))
      | Coq_rf state ->
        'r'::('f'::('_'::(let Rf.Coq_rData v = state in
                          rv_register_name Rf.sz v)))
      | Coq_stack state ->
        's'::('t'::('a'::('c'::('k'::('_'::(Stack.coq_Show_reg_t.show0 state))))))
      | Coq_scoreboard state ->
        's'::('c'::('o'::('r'::('e'::('b'::('o'::('a'::('r'::('d'::('_'::
          (let Scoreboard.Scores state0 = state in
           let Scoreboard.Rf.Coq_rData v = state0 in
           rv_register_name Scoreboard.Rf.sz v)))))))))))
      | Coq_cycle_count ->
  ...
  let coq_FiniteType_reg_t =
    { finite_index = (fun x ->
      match x with
      | Coq_toIMem state -> add 0 (coq_FiniteType_toDMem.finite_index state)
      | Coq_fromIMem state ->
        add (Pervasives.succ (Pervasives.succ 0))
          (coq_FiniteType_fromDMem.finite_index state)
      | Coq_toDMem state ->
        add (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ 0)))) (coq_FiniteType_toDMem.finite_index state)
      | Coq_fromDMem state ->
        add (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ 0))))))
          (coq_FiniteType_fromDMem.finite_index state)
      | Coq_f2d state ->
        add (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ 0)))))))) (coq_FiniteType_f2d.finite_index state)
      | Coq_f2dprim state ->
        add (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ 0))))))))))
      ...
      | Coq_d2e state ->
        add (Pervasives.succ (Pervasives.succ (Pervasives.succ
          ...
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ 0))))))))))))
          (coq_FiniteType_d2e.finite_index state)
      | Coq_e2w state ->
        add (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ 0))))))))))))))
          (coq_FiniteType_e2w.finite_index state)
      | Coq_rf state ->
        add (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
      ...
      | Coq_stack state ->
        add (Pervasives.succ (Pervasives.succ (Pervasives.succ
          ...
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ 0))))))))))))))))))))))))))))))))))))))))))))))))
          (Stack.coq_FiniteType_reg_t.finite_index state)
      | Coq_scoreboard state ->
        add (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
          (Pervasives.succ (Pervasives.succ (Pervasives.succ (Pervasives.succ
      ...
      finite_elements =
      (app
        (map (fun x -> Coq_toIMem x) coq_FiniteType_toDMem.finite_elements)
        (app
          (map (fun x -> Coq_fromIMem x)
            coq_FiniteType_fromDMem.finite_elements)
          (app
            (map (fun x -> Coq_toDMem x)
              coq_FiniteType_toDMem.finite_elements)
            (app
              (map (fun x -> Coq_fromDMem x)
                coq_FiniteType_fromDMem.finite_elements)
              (app
                (map (fun x -> Coq_f2d x) coq_FiniteType_f2d.finite_elements)
                (app
                  (map (fun x -> Coq_f2dprim x)
                    Coq_waitFromFetch.coq_FiniteType_reg_t.finite_elements)
                  (app
                    (map (fun x -> Coq_d2e x)
                      coq_FiniteType_d2e.finite_elements)
                    (app
                      (map (fun x -> Coq_e2w x)
                        coq_FiniteType_e2w.finite_elements)
                      (app
                        (map (fun x -> Coq_rf x)
                          coq_FiniteType_rf.finite_elements)
                        (app
                          (map (fun x -> Coq_stack x)
                            Stack.coq_FiniteType_reg_t.finite_elements)
                          (app
  ...
  | Fetch -> fetch
  | Decode -> decode coq_FiniteType_reg_t Stack.coq_FiniteType_reg_t
  | Execute -> execute coq_FiniteType_reg_t Stack.coq_FiniteType_reg_t
  | Writeback -> writeback coq_FiniteType_reg_t Stack.coq_FiniteType_reg_t
  | WaitImem -> wait_imem
  | Imem -> mem Coq_imem coq_FiniteType_reg_t Stack.coq_FiniteType_reg_t
  | Dmem -> mem Coq_dmem coq_FiniteType_reg_t Stack.coq_FiniteType_reg_t
  | Tick -> tick
    ...
    extract_success
      (let desugared =
         desugar_action dummyPos_unit.dummy_pos
           (decode coq_FiniteType_reg_t Stack.coq_FiniteType_reg_t)
       in
       tc_action eqDec_string coq_R coq_Sigma dummyPos_unit.dummy_pos []
         (Bits_t 0) desugared)
  | Execute ->
    extract_success
      (let desugared =
         desugar_action dummyPos_unit.dummy_pos
           (execute coq_FiniteType_reg_t Stack.coq_FiniteType_reg_t)
       in
       tc_action eqDec_string coq_R coq_Sigma dummyPos_unit.dummy_pos []
         (Bits_t 0) desugared)
  | Writeback ->
    extract_success
      (let desugared =
         desugar_action dummyPos_unit.dummy_pos
           (writeback coq_FiniteType_reg_t Stack.coq_FiniteType_reg_t)
       in
       tc_action eqDec_string coq_R coq_Sigma dummyPos_unit.dummy_pos []
         (Bits_t 0) desugared)
  | WaitImem ->
  ...
  | Imem ->
    extract_success
      (let desugared =
         desugar_action dummyPos_unit.dummy_pos
           (mem Coq_imem coq_FiniteType_reg_t Stack.coq_FiniteType_reg_t)
       in
       tc_action eqDec_string coq_R coq_Sigma dummyPos_unit.dummy_pos []
         (Bits_t 0) desugared)
  | Dmem ->
    extract_success
      (let desugared =
         desugar_action dummyPos_unit.dummy_pos
           (mem Coq_dmem coq_FiniteType_reg_t Stack.coq_FiniteType_reg_t)
       in
       tc_action eqDec_string coq_R coq_Sigma dummyPos_unit.dummy_pos []
         (Bits_t 0) desugared)
  | Tick ->
