...
| FSQRT_S_32F  | FSGNJ_S_32F  | FSGNJN_S_32F  | FSGNJX_S_32F | FMIN_S_32F
| FMAX_S_32F   | FCVT_W_S_32F | FCVT_WU_S_32F | FMV_X_W_32F  | FEQ_S_32F
| FLT_S_32F    | FLE_S_32F    | FCLASS_S_32F  | FCVT_S_W_32F | FCVT_S_WU_32F
| FMV_W_X_32F.

Inductive instruction_RV64F : Type :=
| FLW_64F      | FSW_64F      | FMADD_S_64F   | FMSUB_S_64F  | FNMSUB_S_64F
| FNMADD_S_64F | FADD_S_64F   | FSUB_S_64F    | FMUL_S_64F   | FDIV_S_64F
| FSQRT_S_64F  | FSGNJ_S_64F  | FSGNJN_S_64F  | FSGNJX_S_64F | FMIN_S_64F
| FMAX_S_64F   | FCVT_W_S_64F | FCVT_WU_S_64F | FMV_X_W_64F  | FEQ_S_64F
...
| FNMADD_D_64D  | FADD_D_64D   | FSUB_D_64D    | FMUL_D_64D    | FDIV_D_64D
| FSQRT_D_64D   | FSGNJ_D_64D  | FSGNJN_D_64D  | FSGNJX_D_64D  | FMIN_D_64D
| FMAX_D_64D    | FCVT_S_D_64D | FCVT_D_S_64D  | FEQ_D_64D     | FLT_D_64D
| FLE_D_64D     | FCLASS_D_64D | FCVT_W_D_64D  | FCVT_WU_D_64D | FCVT_D_W_64D
...
Definition InstructionsSet := Ensemble instruction.

Definition RV32I_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
...
Definition RV64I_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
...
Definition RV32Zifencei_instructions : InstructionsSet :=
  Singleton instruction (RV32Zifencei_instruction FENCE_I_32Zifencei).

Definition RV64Zifencei_instructions : InstructionsSet :=
  Singleton instruction (RV64Zifencei_instruction FENCE_I_64Zifencei).

Definition RV32Zicsr_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Empty_set instruction
  ) (RV32Zicsr_instruction CSRRW_32Zicsr )
  ) (RV32Zicsr_instruction CSRRS_32Zicsr )
  ) (RV32Zicsr_instruction CSRRC_32Zicsr )
  ) (RV32Zicsr_instruction CSRRWI_32Zicsr)
  ) (RV32Zicsr_instruction CSRRSI_32Zicsr)
  ) (RV32Zicsr_instruction CSRRCI_32Zicsr).

Definition RV64Zicsr_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Empty_set instruction
  ) (RV64Zicsr_instruction CSRRW_64Zicsr )
  ) (RV64Zicsr_instruction CSRRS_64Zicsr )
  ) (RV64Zicsr_instruction CSRRC_64Zicsr )
  ) (RV64Zicsr_instruction CSRRWI_64Zicsr)
  ) (RV64Zicsr_instruction CSRRSI_64Zicsr)
  ) (RV64Zicsr_instruction CSRRCI_64Zicsr).

Definition RV32M_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
    Empty_set instruction
...
Definition RV64M_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Empty_set instruction
...
Definition RV32A_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Empty_set instruction
...
Definition RV64A_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
...
Definition RV32F_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  ...
  ) (RV32F_instruction FMADD_S_32F  )) (RV32F_instruction FMSUB_S_32F  )
  ) (RV32F_instruction FNMSUB_S_32F )) (RV32F_instruction FNMADD_S_32F )
  ) (RV32F_instruction FADD_S_32F   )) (RV32F_instruction FSUB_S_32F   )
  ) (RV32F_instruction FMUL_S_32F   )) (RV32F_instruction FDIV_S_32F   )
  ) (RV32F_instruction FSQRT_S_32F  )) (RV32F_instruction FSGNJ_S_32F  )
  ) (RV32F_instruction FSGNJN_S_32F )) (RV32F_instruction FSGNJX_S_32F )
  ) (RV32F_instruction FMIN_S_32F   )) (RV32F_instruction FMAX_S_32F   )
  ) (RV32F_instruction FCVT_W_S_32F )) (RV32F_instruction FCVT_WU_S_32F)
  ) (RV32F_instruction FMV_X_W_32F  )) (RV32F_instruction FEQ_S_32F    )
  ) (RV32F_instruction FLT_S_32F    )) (RV32F_instruction FLE_S_32F    )
  ) (RV32F_instruction FCLASS_S_32F )) (RV32F_instruction FCVT_S_W_32F )
  ) (RV32F_instruction FCVT_S_WU_32F)) (RV32F_instruction FMV_W_X_32F  ).

Definition RV64F_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  ...
  ) (RV64F_instruction FMADD_S_64F  )) (RV64F_instruction FMSUB_S_64F  )
  ) (RV64F_instruction FNMSUB_S_64F )) (RV64F_instruction FNMADD_S_64F )
  ) (RV64F_instruction FADD_S_64F   )) (RV64F_instruction FSUB_S_64F   )
  ) (RV64F_instruction FMUL_S_64F   )) (RV64F_instruction FDIV_S_64F   )
  ) (RV64F_instruction FSQRT_S_64F  )) (RV64F_instruction FSGNJ_S_64F  )
  ) (RV64F_instruction FSGNJN_S_64F )) (RV64F_instruction FSGNJX_S_64F )
  ) (RV64F_instruction FMIN_S_64F   )) (RV64F_instruction FMAX_S_64F   )
  ) (RV64F_instruction FCVT_W_S_64F )) (RV64F_instruction FCVT_WU_S_64F)
  ) (RV64F_instruction FMV_X_W_64F  )) (RV64F_instruction FEQ_S_64F    )
  ) (RV64F_instruction FLT_S_64F    )) (RV64F_instruction FLE_S_64F    )
  ) (RV64F_instruction FCLASS_S_64F )) (RV64F_instruction FCVT_S_W_64F )
  ) (RV64F_instruction FCVT_S_WU_64F)) (RV64F_instruction FMV_W_X_64F  )
  ) (RV64F_instruction FCVT_L_S_64F )) (RV64F_instruction FCVT_LU_S_64F)
  ) (RV64F_instruction FCVT_S_L_64F )) (RV64F_instruction FCVT_S_LU_64F).

Definition RV32D_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  ...
  ) (RV32D_instruction FMADD_D_32D )) (RV32D_instruction FMSUB_D_32D  )
  ) (RV32D_instruction FNMSUB_D_32D)) (RV32D_instruction FNMADD_D_32D )
  ) (RV32D_instruction FADD_D_32D  )) (RV32D_instruction FSUB_D_32D   )
  ) (RV32D_instruction FMUL_D_32D  )) (RV32D_instruction FDIV_D_32D   )
  ) (RV32D_instruction FSQRT_D_32D )) (RV32D_instruction FSGNJ_D_32D  )
  ) (RV32D_instruction FSGNJN_D_32D)) (RV32D_instruction FSGNJX_D_32D )
  ) (RV32D_instruction FMIN_D_32D  )) (RV32D_instruction FMAX_D_32D   )
  ) (RV32D_instruction FCVT_S_D_32D)) (RV32D_instruction FCVT_D_S_32D )
  ) (RV32D_instruction FEQ_D_32D   )) (RV32D_instruction FLT_D_32D    )
  ) (RV32D_instruction FLE_D_32D   )) (RV32D_instruction FCLASS_D_32D )
  ) (RV32D_instruction FCVT_W_D_32D)) (RV32D_instruction FCVT_WU_D_32D)
  ) (RV32D_instruction FCVT_D_W_32D)) (RV32D_instruction FCVT_D_WU_32D).

Definition RV64D_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  ...
  ) (RV64D_instruction FMADD_D_64D  )) (RV64D_instruction FMSUB_D_64D  )
  ) (RV64D_instruction FNMSUB_D_64D )) (RV64D_instruction FNMADD_D_64D )
  ) (RV64D_instruction FADD_D_64D   )) (RV64D_instruction FSUB_D_64D   )
  ) (RV64D_instruction FMUL_D_64D   )) (RV64D_instruction FDIV_D_64D   )
  ) (RV64D_instruction FSQRT_D_64D  )) (RV64D_instruction FSGNJ_D_64D  )
  ) (RV64D_instruction FSGNJN_D_64D )) (RV64D_instruction FSGNJX_D_64D )
  ) (RV64D_instruction FMIN_D_64D   )) (RV64D_instruction FMAX_D_64D   )
  ) (RV64D_instruction FCVT_S_D_64D )) (RV64D_instruction FCVT_D_S_64D )
  ) (RV64D_instruction FEQ_D_64D    )) (RV64D_instruction FLT_D_64D    )
  ) (RV64D_instruction FLE_D_64D    )) (RV64D_instruction FCLASS_D_64D )
  ) (RV64D_instruction FCVT_W_D_64D )) (RV64D_instruction FCVT_WU_D_64D)
  ) (RV64D_instruction FCVT_D_W_64D )) (RV64D_instruction FCVT_D_WU_64D)
  ) (RV64D_instruction FCVT_L_D_64D )) (RV64D_instruction FCVT_LU_D_64D)
  ) (RV64D_instruction FMV_X_D_64D  )) (RV64D_instruction FCVT_D_L_64D )
  ) (RV64D_instruction FCVT_D_LU_64D)) (RV64D_instruction FMV_D_X_64D  ).

Definition RV32Q_instructions : InstructionsSet :=
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  Add instruction (Add instruction (Add instruction (Add instruction (
  ...
  ) (RV32Q_instruction FMADD_Q_32Q )) (RV32Q_instruction FMSUB_Q_32Q  )
  ) (RV32Q_instruction FNMSUB_Q_32Q)) (RV32Q_instruction FNMADD_Q_32Q )
  ) (RV32Q_instruction FADD_Q_32Q  )) (RV32Q_instruction FSUB_Q_32Q   )
  ) (RV32Q_instruction FMUL_Q_32Q  )) (RV32Q_instruction FDIV_Q_32Q   )
  ) (RV32Q_instruction FSQRT_Q_32Q )) (RV32Q_instruction FSGNJ_Q_32Q  )
  ) (RV32Q_instruction FSGNJN_Q_32Q)) (RV32Q_instruction FSGNJX_Q_32Q )
  ) (RV32Q_instruction FMIN_Q_32Q  )) (RV32Q_instruction FMAX_Q_32Q   )
  ) (RV32Q_instruction FCVT_S_Q_32Q)) (RV32Q_instruction FCVT_Q_S_32Q )
  ) (RV32Q_instruction FCVT_D_Q_32Q)) (RV32Q_instruction FCVT_Q_D_32Q )
  ) (RV32Q_instruction FEQ_Q_32Q   )) (RV32Q_instruction FLT_Q_32Q    )
  ) (RV32Q_instruction FLE_Q_32Q   )) (RV32Q_instruction FCLASS_Q_32Q )
  ) (RV32Q_instruction FCVT_W_Q_32Q)) (RV32Q_instruction FCVT_WU_Q_32Q)
  ) (RV32Q_instruction FCVT_Q_W_32Q)) (RV32Q_instruction FCVT_Q_WU_32Q).

Definition RV64Q_instructions : InstructionsSet :=
  Add instruction ( Add instruction ( Add instruction ( Add instruction (
  Add instruction ( Add instruction ( Add instruction ( Add instruction (
  Add instruction ( Add instruction ( Add instruction ( Add instruction (
  Add instruction ( Add instruction ( Add instruction ( Add instruction (
  ...
  ) (RV64Q_instruction FMADD_Q_64Q )) (RV64Q_instruction FMSUB_Q_64Q  )
  ) (RV64Q_instruction FNMSUB_Q_64Q)) (RV64Q_instruction FNMADD_Q_64Q )
  ) (RV64Q_instruction FADD_Q_64Q  )) (RV64Q_instruction FSUB_Q_64Q   )
  ) (RV64Q_instruction FMUL_Q_64Q  )) (RV64Q_instruction FDIV_Q_64Q   )
  ) (RV64Q_instruction FSQRT_Q_64Q )) (RV64Q_instruction FSGNJ_Q_64Q  )
  ) (RV64Q_instruction FSGNJN_Q_64Q)) (RV64Q_instruction FSGNJX_Q_64Q )
  ) (RV64Q_instruction FMIN_Q_64Q  )) (RV64Q_instruction FMAX_Q_64Q   )
  ) (RV64Q_instruction FCVT_S_Q_64Q)) (RV64Q_instruction FCVT_Q_S_64Q )
  ) (RV64Q_instruction FCVT_D_Q_64Q)) (RV64Q_instruction FCVT_Q_D_64Q )
  ) (RV64Q_instruction FEQ_Q_64Q   )) (RV64Q_instruction FLT_Q_64Q    )
  ) (RV64Q_instruction FLE_Q_64Q   )) (RV64Q_instruction FCLASS_Q_64Q )
  ) (RV64Q_instruction FCVT_W_Q_64Q)) (RV64Q_instruction FCVT_WU_Q_64Q)
  ) (RV64Q_instruction FCVT_Q_W_64Q)) (RV64Q_instruction FCVT_Q_WU_64Q)
  ) (RV64Q_instruction FCVT_L_Q_64Q)) (RV64Q_instruction FCVT_LU_Q_64Q)
  ) (RV64Q_instruction FCVT_Q_L_64Q)) (RV64Q_instruction FCVT_Q_LU_64Q).
...
Definition foldable_extension_instructions_set
  (b : base_standard) (e : extension) (i : InstructionsSet)
:=
  union i (extension_instructions_set b e).
...
Definition instruction_name (i : instruction) :=
  ...
  | RV32F_instruction x =>
    match x with
    | FLW_32F       => "FLW"       | FSW_32F       => "FSW"
    | FMADD_S_32F   => "FMADD.S"   | FMSUB_S_32F   => "FMSUB.S"
    | FNMSUB_S_32F  => "FNMSUB.S"  | FNMADD_S_32F  => "FNMADD.S"
    | FADD_S_32F    => "FADD.S"    | FSUB_S_32F    => "FSUB.S"
    | FMUL_S_32F    => "FMUL.S"    | FDIV_S_32F    => "FDIV.S"
    | FSQRT_S_32F   => "FSQRT.S"   | FSGNJ_S_32F   => "FSGNJ.S"
    | FSGNJN_S_32F  => "FSGNJN.S"  | FSGNJX_S_32F  => "FSGNJX.S"
    | FMIN_S_32F    => "FMIN.S"    | FMAX_S_32F    => "FMAX.S"
    | FCVT_W_S_32F  => "FCVT.W.S"  | FCVT_WU_S_32F => "FCVT.WU.S"
    | FMV_X_W_32F   => "FMV.X.W"   | FEQ_S_32F     => "FEQ.S"
    | FLT_S_32F     => "FLT.S"     | FLE_S_32F     => "FLE.S"
    | FCLASS_S_32F  => "FCLASS.S"  | FCVT_S_W_32F  => "FCVT.S.W"
    | FCVT_S_WU_32F => "FCVT.S.WU" | FMV_W_X_32F   => "FMV.W.X"
    end
  | RV64F_instruction x =>
    match x with
    | FLW_64F       => "FLW"       | FSW_64F       => "FSW"
    | FMADD_S_64F   => "FMADD.S"   | FMSUB_S_64F   => "FMSUB.S"
    | FNMSUB_S_64F  => "FNMSUB.S"  | FNMADD_S_64F  => "FNMADD.S"
    | FADD_S_64F    => "FADD.S"    | FSUB_S_64F    => "FSUB.S"
    | FMUL_S_64F    => "FMUL.S"    | FDIV_S_64F    => "FDIV.S"
    | FSQRT_S_64F   => "FSQRT.S"   | FSGNJ_S_64F   => "FSGNJ.S"
    | FSGNJN_S_64F  => "FSGNJN.S"  | FSGNJX_S_64F  => "FSGNJX.S"
    | FMIN_S_64F    => "FMIN.S"    | FMAX_S_64F    => "FMAX.S"
    | FCVT_W_S_64F  => "FCVT.W.S"  | FCVT_WU_S_64F => "FCVT.WU.S"
    | FMV_X_W_64F   => "FMV.X.W"   | FEQ_S_64F     => "FEQ.S"
    | FLT_S_64F     => "FLT.S"     | FLE_S_64F     => "FLE.S"
    | FCLASS_S_64F  => "FCLASS.S"  | FCVT_S_W_64F  => "FCVT.S.W"
    | FCVT_S_WU_64F => "FCVT.S.WU" | FMV_W_X_64F   => "FMV.W.X"
    | FCVT_L_S_64F  => "FCVT.L.S"  | FCVT_LU_S_64F => "FCVT.LU.S"
    | FCVT_S_L_64F  => "FCVT.S.L"  | FCVT_S_LU_64F => "FCVT.S.LU"
    end
  | RV32D_instruction x =>
    match x with
    | FLD_32D      => "FLD"      | FSD_32D       => "FSD"
    | FMADD_D_32D  => "FMADD.D"  | FMSUB_D_32D   => "FMSUB.D"
    | FNMSUB_D_32D => "FNMSUB.D" | FNMADD_D_32D  => "FNMADD.D"
    | FADD_D_32D   => "FADD.D"   | FSUB_D_32D    => "FSUB.D"
    | FMUL_D_32D   => "FMUL.D"   | FDIV_D_32D    => "FDIV.D"
    | FSQRT_D_32D  => "FSQRT.D"  | FSGNJ_D_32D   => "FSGNJ.D"
    | FSGNJN_D_32D => "FSGNJN.D" | FSGNJX_D_32D  => "FSGNJX.D"
    | FMIN_D_32D   => "FMIN.D"   | FMAX_D_32D    => "FMAX.D"
    | FCVT_S_D_32D => "FCVT.S.D" | FCVT_D_S_32D  => "FCVT.D.S"
    | FEQ_D_32D    => "FEQ.D"    | FLT_D_32D     => "FLT.D"
    | FLE_D_32D    => "FLE.D"    | FCLASS_D_32D  => "FCLASS.D"
    | FCVT_W_D_32D => "FCVT.W.D" | FCVT_WU_D_32D => "FCVT.WU.D"
    | FCVT_D_W_32D => "FCVT.D.W" | FCVT_D_WU_32D => "FCVT.D.WU"
    end
  | RV64D_instruction x =>
    match x with
    | FLD_64D       => "FLD"       | FSD_64D       => "FSD"
    | FMADD_D_64D   => "FMADD.D"   | FMSUB_D_64D   => "FMSUB.D"
    | FNMSUB_D_64D  => "FNMSUB.D"  | FNMADD_D_64D  => "FNMADD.D"
    | FADD_D_64D    => "FADD.D"    | FSUB_D_64D    => "FSUB.D"
    | FMUL_D_64D    => "FMUL.D"    | FDIV_D_64D    => "FDIV.D"
    | FSQRT_D_64D   => "FSQRT.D"   | FSGNJ_D_64D   => "FSGNJ.D"
    | FSGNJN_D_64D  => "FSGNJN.D"  | FSGNJX_D_64D  => "FSGNJX.D"
    | FMIN_D_64D    => "FMIN.D"    | FMAX_D_64D    => "FMAX.D"
    | FCVT_S_D_64D  => "FCVT.S.D"  | FCVT_D_S_64D  => "FCVT.D.S"
    | FEQ_D_64D     => "FEQ.D"     | FLT_D_64D     => "FLT.D"
    | FLE_D_64D     => "FLE.D"     | FCLASS_D_64D  => "FCLASS.D"
    | FCVT_W_D_64D  => "FCVT.W.D"  | FCVT_WU_D_64D => "FCVT.WU.D"
    | FCVT_D_W_64D  => "FCVT.D.W"  | FCVT_D_WU_64D => "FCVT.D.WU"
    | FCVT_L_D_64D  => "FCVT.L.D"  | FCVT_LU_D_64D => "FCVT.LU.D"
    | FMV_X_D_64D   => "FMV.X.D"   | FCVT_D_L_64D  => "FCVT.D.L"
    | FCVT_D_LU_64D => "FCVT.D.LU" | FMV_D_X_64D   => "FMV.D.X"
    end
  | RV32Q_instruction x =>
    match x with
    | FLQ_32Q       => "FLQ"      | FSQ_32Q       => "FSQ"
    | FMADD_Q_32Q   => "FMADD.Q"  | FMSUB_Q_32Q   => "FMSUB.Q"
    | FNMSUB_Q_32Q  => "FNMSUB.Q" | FNMADD_Q_32Q  => "FNMADD.Q"
    | FADD_Q_32Q    => "FADD.Q"   | FSUB_Q_32Q    => "FSUB.Q"
    | FMUL_Q_32Q    => "FMUL.Q"   | FDIV_Q_32Q    => "FDIV.Q"
    | FSQRT_Q_32Q   => "FSQRT.Q"  | FSGNJ_Q_32Q   => "FSGNJ.Q"
    | FSGNJN_Q_32Q  => "FSGNJN.Q" | FSGNJX_Q_32Q  => "FSGNJX.Q"
    | FMIN_Q_32Q    => "FMIN.Q"   | FMAX_Q_32Q    => "FMAX.Q"
    | FCVT_S_Q_32Q  => "FCVT.S.Q" | FCVT_Q_S_32Q  => "FCVT.Q.S"
    | FCVT_D_Q_32Q  => "FCVT.D.Q" | FCVT_Q_D_32Q  => "FCVT.Q.D"
    | FEQ_Q_32Q     => "FEQ.Q"    | FLT_Q_32Q     => "FLT.Q"
    | FLE_Q_32Q     => "FLE.Q"    | FCLASS_Q_32Q  => "FCLASS.Q"
    | FCVT_W_Q_32Q  => "FCVT.W.Q" | FCVT_WU_Q_32Q => "FCVT.WU.Q"
    | FCVT_Q_W_32Q  => "FCVT.Q.W" | FCVT_Q_WU_32Q => "FCVT.Q.WU"
    end
  | RV64Q_instruction x =>
    match x with
    | FLQ_64Q       => "FLQ"      | FSQ_64Q       => "FSQ"
    | FMADD_Q_64Q   => "FMADD.Q"  | FMSUB_Q_64Q   => "FMSUB.Q"
    | FNMSUB_Q_64Q  => "FNMSUB.Q" | FNMADD_Q_64Q  => "FNMADD.Q"
    | FADD_Q_64Q    => "FADD.Q"   | FSUB_Q_64Q    => "FSUB.Q"
    | FMUL_Q_64Q    => "FMUL.Q"   | FDIV_Q_64Q    => "FDIV.Q"
    | FSQRT_Q_64Q   => "FSQRT.Q"  | FSGNJ_Q_64Q   => "FSGNJ.Q"
    | FSGNJN_Q_64Q  => "FSGNJN.Q" | FSGNJX_Q_64Q  => "FSGNJX.Q"
    | FMIN_Q_64Q    => "FMIN.Q"   | FMAX_Q_64Q    => "FMAX.Q"
    | FCVT_S_Q_64Q  => "FCVT.S.Q" | FCVT_Q_S_64Q  => "FCVT.Q.S"
    | FCVT_D_Q_64Q  => "FCVT.D.Q" | FCVT_Q_D_64Q  => "FCVT.Q.D"
    | FEQ_Q_64Q     => "FEQ.Q"    | FLT_Q_64Q     => "FLT.Q"
    | FLE_Q_64Q     => "FLE.Q"    | FCLASS_Q_64Q  => "FCLASS.Q"
    | FCVT_W_Q_64Q  => "FCVT.W.Q" | FCVT_WU_Q_64Q => "FCVT.WU.Q"
    | FCVT_Q_W_64Q  => "FCVT.Q.W" | FCVT_Q_WU_64Q => "FCVT.Q.WU"
    | FCVT_L_Q_64Q  => "FCVT.L.Q" | FCVT_LU_Q_64Q => "FCVT.LU.Q"
    | FCVT_Q_L_64Q  => "FCVT.Q.L" | FCVT_Q_LU_64Q => "FCVT.Q.LU"
    end
  end.
