  ...
  Section Action.
    ...
    : result ({ tau: type & action sig tau }) :=
      ...
      | UUnop fn arg1 =>
        ...
        let/res arg1' :=
          cast_action pos1 (PrimSignatures.Sigma1 fn).(arg1Sig) (``arg1') in
      ...
      | UBinop fn arg1 arg2 =>
        ...
        let/res fn :=
          ...
          (PrimTypeInference.tc2 fn `arg1' `arg2') in
        let/res arg1' :=
          cast_action pos1 (PrimSignatures.Sigma2 fn).(arg1Sig) (``arg1') in
        let/res arg2' :=
          cast_action pos2 (PrimSignatures.Sigma2 fn).(arg2Sig) (``arg2') in
