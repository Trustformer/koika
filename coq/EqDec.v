...
Proof. unfold beq_dec; destruct eq_dec; subst; intuition congruence. Qed.
...
: forall (pr2 pr1: x = y), eq_rect x P px y pr1 = eq_rect x P px y pr2.
Proof.
  destruct pr1; cbn; intros.
  symmetry; apply eq_dec_rew_type_family.
Qed.

Lemma eq_dec_refl {A} {EQ: EqDec A}: forall a, eq_dec a a = left eq_refl.
Proof.
  intros.
  destruct eq_dec.
