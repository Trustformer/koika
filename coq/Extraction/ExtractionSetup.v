...
Extraction Implicit CircuitForm.Optimization.unannot [CR CSigma rwdata].
Extraction Implicit CircuitForm.Optimization.lco_iter [csigma].
Extraction Implicit CircuitForm.Optimization.lco_compose [csigma].
Extraction Implicit CircuitForm.Optimization.lco_constprop [csigma].
Extraction Implicit CircuitForm.Optimization.lco_identical [csigma].
Extraction Implicit CircuitForm.Optimization.lco_muxelim [csigma].
Extraction Implicit CircuitForm.Optimization.lco_simplify [csigma].
Extraction Implicit CircuitForm.Optimization.lco_partialeval [csigma].
Extraction Implicit CircuitForm.Optimization.lco_all [csigma].
Extraction Implicit CircuitForm.Optimization.lco_all_iterated [csigma].
Extraction Implicit CircuitForm.Optimization.unannot [CR CSigma rwdata].
...
Extraction Implicit SyntaxFunctions.action_footprint [R Sigma sig tau].
Extraction Implicit SyntaxFunctions.action_footprint' [R Sigma sig tau].
